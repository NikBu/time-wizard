...
// _trackLib: global pool  { id, name, url, audio, duration }
// _playlists: [ { id, name, locked, trackIds:[] } ]
let _trackLib = [];
let _playlists = [];
let _activePLId = null;   // currently selected playlist id
let _activeTrackId = null; // currently selected track id (lib id or ambient id)
